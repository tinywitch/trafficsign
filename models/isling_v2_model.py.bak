...
class Islingv2(object):
    ...
    def _build_model(self):
        ...
        #     x = self._spatial_transformer('ST_2', x, 128, [128, 128, 128])
        ...
        with tf.variable_scope('fc_1'):
            ...
            x = self._batch_norm2('fc_1', x, trainable=False)
            x = self._relu(x)
    ...
    def _conv_Bn_ReLU(self, name, x, filter_size, in_filters, out_filters, strides, trainable=False):
        """Convolution."""
    ...
    def _fully_connected(self, name, x, out_dim, trainable=False):
    ...
    def _spatial_transformer(self, name, x, in_filters, arr_out_filters):
        ...
        with tf.variable_scope(name):
            ...
            with tf.variable_scope('fc1'):
                ...
                _x = Dense(_x_flat, _x_size, arr_out_filters[2], use_relu=True, name='fc1')

            _x = slim.dropout(_x, self._dropout,
                              is_training=(self.mode == 'train'
                                           and self._dropout > 0),
                              scope='dropout')

            with tf.variable_scope('fc2'):
                _x = Dense(_x, arr_out_filters[2], 6, use_relu=False, trans=True, name='fc2')
